...
* **Rsyslog** позволил нам отфильтровать трафик: *"Если данные пришли с IP 192.168.4.2 (Микротик) — положи их в отдельный файл `mikrotik.log`"*. Это физически разделило потоки данных.
